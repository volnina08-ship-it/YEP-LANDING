...
const EN = {
  ...
  'stats.years': 'years in the market', 'stats.films': 'films', 'stats.brands': 'Hungarian brands',
  'marquee.1': 'Commercials', 'marquee.2': 'Social content', 'marquee.3': 'Events',
  ...
  'projects.1.sub': 'Campaign film', 'projects.2.sub': 'Campaign', 'projects.3.sub': '1-hour documentary', 'projects.4.sub': 'Campaign',
  ...
  'form.name': 'Name *', 'form.email': 'E-mail *', 'form.phone': 'Phone', 'form.company': 'Company / brand',
  'form.service': 'What are you interested in?', 'form.service.0': 'Choose…', 'form.service.1': 'Commercials & campaigns',
  'form.service.2': 'Social content', 'form.service.3': 'Events', 'form.service.4': 'Photography', 'form.service.5': 'Other / not sure yet',
  'form.budget': 'Planned budget', 'form.budget.0': 'Choose…', 'form.budget.5': 'Not sure yet',
  'form.intro': 'What is the project about? *',
  'form.intro.ph': 'E.g. a 60-second brand film for a new premium product, shooting in October',
  'form.message': 'Message', 'form.message.ph': 'Anything else that matters: deadline, platforms, references…',
